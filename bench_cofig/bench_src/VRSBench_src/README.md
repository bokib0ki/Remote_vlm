...
VRSBench is a Versatile Vision-Language Benchmark for Remote Sensing Image Understanding. It consists of 29,614 remote sensing images with detailed captions, 52,472 object refers, and 123,221 visual question-answer pairs. It facilitates the training and evaluation of vision-language models across a broad spectrum of remote sensing image understanding tasks. 

## 🗓️ Updates
- [x] **[2026.02.01]** We release [VRSBench-SAR](https://huggingface.co/datasets/xiang709/VRSBench-SAR), image-text annotations for [SARDet-100k](https://github.com/zcablii/SARDet_100K) dataset. Note: annotations are automatically generated by GPT-5.1 without human verification.
...
- GPT-4 inference: Given input prompts, we call the OpenAI API to automatically generate image captions, object referring, and question-answer pairs based on the prompts. Use the ```extract_patch_json.py``` to get initial annotations for image captioning, visual grounding, and VQA tasks using GPT-4V.
